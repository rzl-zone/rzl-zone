...
import { slugsPlugin, type SlugFn } from "@/source/plugins/slugs";
...
export type ResolvePage<T> = T extends { slug: infer S extends string }
  ? S
  : T extends string
    ? T
    : never;
