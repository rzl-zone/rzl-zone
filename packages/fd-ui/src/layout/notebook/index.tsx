...
import {
  LayoutNotebookBody,
  LayoutNotebookProvider,
  LayoutNotebookHeader,
  LayoutNotebookHeaderTabs,
  NavbarLinkItem
} from "./client";
import {
  Sidebar,
                ...
                {collapsible && (
                  <SidebarCollapseTrigger
                    className={cn(
                      ...
                      "border bg-fd-secondary/50 text-start text-fd-secondary-foreground transition-colors hover:bg-fd-accent p-2"
                    )}
                  >
                    <SidebarIcon />
                  </SidebarCollapseTrigger>
    ...
    <TreeContextProvider tree={tree}>
      ...
      >
        <Sidebar
          ...
          prefetch={prefetch}
        >
          <LayoutNotebookBody {...props.containerProps}>
            {sidebar()}
            <DocsNavbar
              {...props}
              links={links}
          ...
          {sidebarCollapsible && navMode === "auto" && (
            <SidebarCollapseTrigger
              className={cn(
                ...
                "border bg-fd-secondary/50 text-start text-fd-secondary-foreground transition-colors hover:bg-fd-accent p-2 rounded-full"
              )}
            >
              <SidebarIcon />
            </SidebarCollapseTrigger>
          ...
          (searchToggle.components?.lg ? (
            <div
              className={cn(
                ...
                navMode === "top" ? "rounded-xl max-w-sm" : "max-w-60"
              )}
            >
              {searchToggle.components.lg}
            </div>
            ...
            <LargeSearchToggle
              ...
              className={cn(
                "w-full my-auto max-md:hidden",
                navMode === "top" ? "rounded-xl max-w-sm ps-2.5" : "max-w-60"
              )}
            />
          ))}
