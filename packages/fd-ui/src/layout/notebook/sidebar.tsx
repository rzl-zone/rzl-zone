        ...
        >
          ...
          <aside
            ...
            className={cn(
              ...
              collapsed && [
                "inset-y-2 rounded-xl bg-fd-card transition-transform border-2 w-(--fd-sidebar-width)",
                // "bg-fd-background",
                hovered
  ...
  return (
    <>
      ...
      <Base.SidebarDrawerContent
        className={cn(
          "fixed text-[0.9375rem] flex flex-col shadow-lg border-s end-0 inset-y-0 w-[85%] max-w-95 z-40 bg-fd-background data-[state=open]:animate-fd-sidebar-in data-[state=closed]:animate-fd-sidebar-out",
          className
        )}
        {...props}
      >
...
export function SidebarFolderTrigger({
  ...
  return (
    <Base.SidebarFolderTrigger
      ...
      style={{
        paddingInlineStart: getItemOffset((depth ?? 0) - 1),
        ...style
      }}
      {...props}
    >
