 ...
 *      - Checks deeply nested arrays/objects — if any value inside is "non-empty",
 *        returns `true`.
 *
 * ---
 ...
 *
 * ---
 * @returns {boolean} Return `true` if the value or anything nested inside is non-empty,
 *                    otherwise `false`.
 *
 * ---
 * @example
 * toBooleanContentDeep(null);
 * // ➔ false
 * toBooleanContentDeep("");
 * // ➔ false
 * toBooleanContentDeep(0);
 * // ➔ false
 * toBooleanContentDeep([]);
 * // ➔ false
 * toBooleanContentDeep({});
 ...
 * toBooleanContentDeep([[], {}]);
 * // ➔ false
 * toBooleanContentDeep("abc");
 * // ➔ true
 * toBooleanContentDeep(42);
 * // ➔ true
 * toBooleanContentDeep(NaN);
 * // ➔ true
 * toBooleanContentDeep([0, "", 5]);
 * // ➔ true
 * toBooleanContentDeep([NaN, "", 0]);
 * // ➔ true
 * toBooleanContentDeep([0, "", null]);
 * // ➔ false
 * toBooleanContentDeep({ a: 0 });
 * // ➔ false
 * toBooleanContentDeep({ a: 1 });
 * // ➔ true
 * toBooleanContentDeep({ a: { b: [] }});
 * // ➔ false
 * toBooleanContentDeep({ a: { b: "x" }});
 * // ➔ true
 * toBooleanContentDeep({[Symbol("key")]: 123});
 * // ➔ false
 */
