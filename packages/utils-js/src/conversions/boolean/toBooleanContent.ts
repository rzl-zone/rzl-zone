 ...
 * @returns {boolean} Return `true` if the value is considered non-empty,
 *                    otherwise `false`.
 *
 * ---
 * @example
 ...
 * // ➔ true
 * toBooleanContent(" asd ");
 * // ➔ true
 * toBooleanContent(0);
 * // ➔ false
 * toBooleanContent(42);
 * // ➔ true
 * toBooleanContent(NaN);
 * // ➔ true
 * toBooleanContent([]);
 * // ➔ false
 * toBooleanContent([1]);
 ...
 * toBooleanContent({});
 * // ➔ false
 * toBooleanContent({ a: 1 });
 * // ➔ true
 * toBooleanContent({[Symbol("key")]: 123});
 * // ➔ false
 */
