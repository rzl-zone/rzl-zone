 ...
 * - Numeric strings with optional thousands separators (e.g. `"3,567,890.14"`) ➔ `3567890.14`
 *   ***as a `number` type***.
 ...
 *
 * ---
 * @returns {*} The converted JavaScript primitive (***`boolean`***, ***`number`***, ***`null`***,
 *              ***`undefined`***, ***`NaN`***) or the original value if no conversion applies.
 *
 * ---
 * @example
 * convertType("true");
