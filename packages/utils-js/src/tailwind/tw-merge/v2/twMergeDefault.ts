import type { OptionsMergeTwClsV2, TwMergeDefaultFnV2 } from "./_private/types";

import { extendTailwindMerge, getDefaultConfig } from "tailwind-merge-v2";
...
/** -------------------------------------------------------------
 * * ***Customized Tailwind class merger Version 2 with extended rules.***
 * -------------------------------------------------------------
 * **Wraps ***`extendTailwindMerge` from [`twMerge version 2`](https://github.com/dcastil/tailwind-merge/tree/v2.6.0)*** with Tailwind’s default
 * config (_*`getDefaultConfig()` from [`twMerge version 2`](https://github.com/dcastil/tailwind-merge/tree/v2.6.0)*_) to create a **project-ready `twMerge`**.**
 *
 * ---
 * - **When to use it?**
 ...
 *
 * ---
 * @param {OptionsMergeTwClsV2} [options={}]
 *  ***Merge options:***
 ...
 *    import { twMergeDefaultV2 } from "@rzl-zone/utils-js/tailwind";
 *
 *    const twMerge2 = twMergeDefaultV2({
 *      extend: {
 *        classGroups: {
 ...
 *    import { twMergeDefaultV2 } from "@rzl-zone/utils-js/tailwind";
 *
 *    const twMerge3 = twMergeDefaultV2({ config });
 *
 ...
 *    import { customCnV3, twMergeDefaultV2, type ClassValues } from "@rzl-zone/utils-js/tailwind";
 *
 *    const customTwMerge = twMergeDefaultV2({
 *      config: configTwCss,
 *      extend: {
 ...
 *    ```
 */
export const twMergeDefaultV2 = (
  options: OptionsMergeTwClsV2 = {}
): TwMergeDefaultFnV2 => {
