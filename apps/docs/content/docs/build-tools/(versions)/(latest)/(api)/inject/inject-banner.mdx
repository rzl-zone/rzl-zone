...
<Callout type="info" title={<strong>Learn more</strong>}> 
  - See <CustomNextLink href="#pattern">`pattern`</CustomNextLink> for file matching and filtering rules.
  - See <CustomNextLink href="#banner-text">`bannerText`</CustomNextLink> for injection behavior, ordering, and normalization.
  - See <CustomNextLink href="#replace-banner">`replaceBanner`</CustomNextLink>, <CustomNextLink href="#banner-position">`bannerPosition`</CustomNextLink>, and <CustomNextLink href="#remove-duplicate">`removeDuplicate`</CustomNextLink> for advanced options. 
</Callout>
