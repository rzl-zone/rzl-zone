...
<section data-options="docs">
  ...
  <div className="ml-4">
    - **Description:**  
      ...
      <Callout type="info">
        Overrides the default behavior of loading `package.json` via <PackageLink packageName="build-tools" toPath="/get/get-package-json">`getPackageJson()`</PackageLink>.
      </Callout> 
    ...
    - **Default:**  
      Loaded from <PackageLink packageName="build-tools" toPath="/get/get-package-json">`getPackageJson()`</PackageLink>.
