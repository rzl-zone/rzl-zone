...
<Callout type="info" title={<strong>Learn more</strong>}>
  - See <CustomNextLink href="#directive">`directive`</CustomNextLink> for injection behavior, normalization, and examples.
  - See <CustomNextLink href="#pattern">`pattern`</CustomNextLink> for file matching and processing rules.
</Callout>
...
<Callout type="info" title={<strong>Info</strong>}>
  ...
  <CustomNextLink href="#pattern-options">`options.patternOptions`</CustomNextLink>  
