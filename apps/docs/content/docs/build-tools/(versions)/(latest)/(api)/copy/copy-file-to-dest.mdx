...
- **The function supports:**
  ...
  - When using a Set, it is recommended to use [`createCopyFileToDestParameterSet()`](#create-copy-file-to-dest-parameter-set) to ensure proper TypeScript inference and autocomplete support.
...
### `createCopyFileToDestParameterSet` [#create-copy-file-to-dest-parameter-set]
