...
pageNameAlias: "Cleaner: cleanJsBuildArtifacts"
...
packageMeta:
  ...
  tag: [build-tools]
pageData:
  title: "Cleaner: cleanJsBuildArtifacts"
...
<AutoTypeTable path="./content/docs/build-tools/(versions)/(latest)/(api)/cleaner/props.ts" name="CleanJsBuildArtifacts" />
...
<section data-options="docs">
  ...
  <div className="ml-4">
    ...
    - **Default:**  
      *`false`*  
    - **Example:**   
      ```js title="Before (dist/index.js)" disableCopy
      const a = 1;
      ...
      ```js title="After (dist/index.js)" disableCopy 
      const a = 1;
      const b = 2;
      //# sourceMappingURL=index.js.map
      ```
...
<ApiVersionInfoComp packageName='build-tools' categoryApi='cleaner' nameApi='cleanJsBuildArtifacts' />
