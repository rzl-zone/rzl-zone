...
pageNameAlias: "Cleaner: cleanTypesBuildArtifacts"
...
packageMeta:
  ...
  tag: [build-tools]
pageData:
  title: "Cleaner: cleanTypesBuildArtifacts"
...
- Prepares cleaner files for production or distribution.
...
<AutoTypeTable path="./content/docs/build-tools/(versions)/(latest)/(api)/cleaner/props.ts" name="CleanTypesBuildArtifacts" />
...
<section data-options="docs">
  ...
  <div className="ml-4">
    ...
    - **Default:**  
      *`false`*  
    - **Example:**   
      ```js title="Before (dist/index.d.ts)" disableCopy 
      type a = string;
      ...
      ```js title="After (dist/index.d.ts)" disableCopy 
      type a = string;
      type b = boolean;
      //# sourceMappingURL=index.d.ts.map
      ```
...
<ApiVersionInfoComp packageName='build-tools' categoryApi='cleaner' nameApi='cleanTypesBuildArtifacts' />
