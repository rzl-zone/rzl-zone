...
<section data-options="docs">
  ...
  <div className="ml-4">
    ...
    <Callout type="info" title={<strong>Behavior</strong>}>
      <div className="ml-4">
        - `true` uses an automatically generated banner from `package.json` via <PackageLink packageName="build-tools" toPath="/generate/generate-package-banner">`generatePackageBanner()`</PackageLink>.  
