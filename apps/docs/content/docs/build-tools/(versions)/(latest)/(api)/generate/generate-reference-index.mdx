...
packageMeta:
  ...
  tag: [build-tools]
pageData:
  title: "API: generateReferenceIndex"
...
<Callout type="info" title={<strong>Info</strong>}>
  Pattern resolution behavior can be customized via <CustomNextLink href="#pattern-options">`options.patternOptions`</CustomNextLink> such as hidden files, case sensitivity, concurrency, and ignore rules.
</Callout>
